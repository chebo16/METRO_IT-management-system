...
public class MaintenanceRecordServiceTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            requireCondition(
                    differentEquipment.getId() != null,
                    "Different equipment has no ID."
            );
            ...
            requireCondition(
                    createdIncident.getAssignedTechnicianId() != null
                            && createdIncident
            ...
            List<MaintenanceRecord> incidentRecords =
                    maintenanceService.getRecordsByIncident(
                            incidentId
                    );
            ...
            List<MaintenanceRecord> equipmentRecords =
                    maintenanceService.getRecordsByEquipment(
                            equipmentId
                    );
            ...
            List<MaintenanceRecord> technicianRecords =
                    maintenanceService.getRecordsByTechnician(
                            technicianId
                    );
            ...
            expectValidationException(
                    ...
                    "Equipment mismatch was not rejected."
            );
            ...
            if (technicians.size() > 1) {
                ...
                requireCondition(
                        differentTechnician.getId() != null,
                        "Different technician has no ID."
                );
            ...
            expectValidationException(
                    () -> maintenanceService.getRecordById(0),
            ...
            requireCondition(
                    recordsAfterCleanup == recordsBeforeCreate,
            ...
            requireCondition(
                    incidentsAfterCleanup == incidentsBeforeCreate,
            ...
            System.out.println(
                    "20. All MaintenanceRecordService operations "
                            + "completed successfully."
            );
